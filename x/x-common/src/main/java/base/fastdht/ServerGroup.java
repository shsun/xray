...
package base.fastdht;

import java.io.IOException;
import java.net.InetSocketAddress;
import java.net.Socket;

import base.common.IniFileReader;
...
public class ServerGroup {
    ...
    public boolean connectServer(ServerInfo server) {
        ...
        try {
            ...
            System.err.println("connect to server " + server.address.getAddress().getHostAddress() + ":" + server.address.getPort() + " fail, error info: "
                    + ex.getMessage());
            return false;
        }
    }
